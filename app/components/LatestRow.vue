...
<template>
  <NuxtLink
    ...
    class="grid grid-cols-[28px_76px_minmax(0,1fr)_64px_52px] items-center gap-2.5 rounded-lg px-2 py-1.5 text-[12px] text-muted-foreground transition-colors hover:bg-accent"
  >
    <img class="size-[26px] rounded-lg border bg-muted object-cover" :src="faviconUrl(props.tool.domain)" width="26" height="26" loading="lazy" alt="">
